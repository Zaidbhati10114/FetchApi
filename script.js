...
// Add Button Func in Query | Headers
...
// Defines the api timing per request
...
function updateEndTime(response) {
  response.customData = response.customDate || {};
  ...
  axios({
    ...
    .then(response => {
      ...
      document
        ...
        .classList.remove("d-none"); // Removes Display none property
